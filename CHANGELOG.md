...
- Open VSX: publication depuis GitHub Actions (secret `OVSX_PAT`), même `.vsix` que pour le Visual Studio Marketplace.
- Script `publish:openvsx` et dépendance de dev `ovsx`.
...
[Unreleased]: https://github.com/Code-and-Sorcery/vscode-env-checker/compare/v0.1.2...HEAD
[0.1.2]: https://github.com/Code-and-Sorcery/vscode-env-checker/compare/v0.1.1...v0.1.2
